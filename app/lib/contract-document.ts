...
export const acmeMasterDocument: ContractDocument = {
  ...
  documentNumber: "MSA-ACME-2025-01",
  sections: [
    {
      id: "section-recitals",
      clauseId: null,
      heading: "Recitals",
      body: [
        "This Master Subscription Agreement (the \"Agreement\") is entered into as of January 1, 2025 (the \"Effective Date\") by and between Conduit Data Platform, Inc. (\"Vendor\") and Acme Corporation (\"Customer\").",
    ...
    },
    {
      ...
      body: [
        "The initial term of this Agreement (the \"Initial Term\") begins on the Effective Date of January 1, 2025 and continues for twelve (12) months, ending on December 31, 2025.",
    ...
    },
    {
      id: "section-4",
      clauseId: "cl_tprice",
      heading: "Section 4. Fees and Annual Commit",
      body: [
        "Customer agrees to pay Vendor a total subscription fee of $1.20 million for the Initial Term, representing an annual commit for access to the Service. The annual commit is recognized straight-line over the twelve (12) month Initial Term at $100,000 per month.",
        "The annual commit reflects fixed consideration under ASC 606-10-32-2 and constitutes the transaction price allocated to the single performance obligation defined in Section 2 (subject to the variable-consideration provisions in Section 5).",
    ...
    },
    {
      ...
      body: [
        "Vendor will invoice Customer monthly in advance for the monthly portion of the annual commit. Overage, if any, will be invoiced monthly in arrears together with the next monthly commit invoice.",
    ...
    },
    {
      ...
      clauseId: null,
      heading: "Exhibit A. Order Form (2025-01-01)",
      body: [
        "Subscription: Acme Data Platform — single performance obligation, full-platform access.",
        "Initial Term: 12 months, January 1, 2025 through December 31, 2025.",
        "Annual Commit: $1.20 million, billed at $100,000 per month, in advance, net 30.",
